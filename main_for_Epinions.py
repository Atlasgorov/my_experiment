...
def experiment_on_Epinions(percentage):
    ...
    rumor_sources_percentage = percentage  # 谣言源节点比例设为1.5%
    ...
    np.savetxt(r'./experiment_results/Epinions/betweenness_centrality_result.csv', betweenness_centrality_result,
    ...
    """
    # 存储不同谣言规模下的结果
    f1 = open(r'./experiment_results/Epinions/results_new_Epinions.txt', 'a')
    f1.write("******************************************************\n")
