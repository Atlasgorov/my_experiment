...
def experiment_on_Gnutella08(percentage):
    ...
    np.savetxt(r'./experiment_results/Gnutella08/betweenness_centrality_result.csv', betweenness_centrality_result,
    ...
    """
    # 存储不同谣言规模下的结果
    f1 = open(r'./experiment_results/Gnutella08/results_new_Gnutella08.txt', 'a')
    f1.write("******************************************************\n")
