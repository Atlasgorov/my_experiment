...
def experiment_on_WikiVote():
    ...
    rumor_sources_number = int(rumor_community_size * rumor_sources_percentage) # 32
    ...
    betweenness_centrality_result = np.concatenate(([rumor_sources_number],betweenness_centrality_result,[betweenness_centrality_average_result]))
    ...
    run_time_betweenness_centrality = np.concatenate(([rumor_sources_number],run_time_betweenness_centrality,[average_run_time_betweenness_centrality]))
    ...
    np.savetxt(r'./experiment_results/wiki_vote/betweenness_centrality_result.csv', betweenness_centrality_result, delimiter=',',header=data_header,fmt="%d")
    ...
    np.savetxt(r'./experiment_results/wiki_vote/run_time_betweenness_centrality.csv', run_time_betweenness_centrality, delimiter=',',
               header=data_header)
    """
    # 打印平均结果
